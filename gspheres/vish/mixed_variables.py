...
@cov.Kuu.register(MixedFeatures, SphericalMatern)
def Kuu_sphericalmatern_mixedfeatures(
    ...
    eigenvalues = kernel.eigenvalues(
        len(inducing_variable.spherical_harmonics)
    )
...
@cov.Kuf.register(MixedFeatures, SphericalMatern, TensorLike)
...
# @kl.prior_kl.register(MixedFeatures, SphericalMatern, TensorLike, TensorLike)
...
#     TensorLike, MixedFeatures, gpflow.kernels.Kernel, TensorLike
# )
